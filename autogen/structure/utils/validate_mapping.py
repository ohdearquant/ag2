# copied from https://github.com/lion-agi/lion-os/blob/main/lion/libs/parse/validate/mapping.py
# copyright by HaiyangLi, APACHE LICENSE 2.0
from collections.abc import Callable, Sequence
from typing import Any, Literal

from .string_similarity import SIMILARITY_TYPE
from .to_json import to_dict, to_json
from .validate_keys import KeysDict, validate_keys
